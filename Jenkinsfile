...
success {
mail bcc: '',
body: "Unit and Integration Tests stage passed successfully! View logs at:
${env.BUILD_URL}",
subject: "SUCCESS!!: Unit and Integration Tests Stage for ${env.JOB_NAME}
#${env.BUILD_NUMBER}",
...
subject: "FAILURE: Unit and Integration Tests Stage for ${env.JOB_NAME}
#${env.BUILD_NUMBER}",
to: 'kyleerikoris@gmail.com'
}
}
...
subject: "SUCCESS: Security Scan Stage for ${env.JOB_NAME}
#${env.BUILD_NUMBER}",
to: 'kyleerikoris@gmail.com'
}
failure {
...
subject: "FAILURE: Security Scan Stage for ${env.JOB_NAME}
#${env.BUILD_NUMBER}",
to: 'kyleerikoris@gmail.com'
}
}
